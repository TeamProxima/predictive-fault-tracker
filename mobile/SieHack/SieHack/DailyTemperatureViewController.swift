...
//  Siemens Hackathon2
//
//  Created by Emre Yigit Alparslan on 10/22/16.
...
class DailyTemperatureViewController: UIViewController {
    ...
    func getDataFromDatabase(){
        ...
        humidityLineChart.isUserInteractionEnabled = false
        activityIndi.isHidden = false
        activityIndi.startAnimating()
        
        let url = URL(string: "http://\(rasIP)/daily")!
                ...
                if let urlContent = data{
                    do{
                        ...
                        DispatchQueue.main.sync(execute: {
                            ...
                            self.lineChart.isUserInteractionEnabled = true
                            self.humidityLineChart.isUserInteractionEnabled = true
